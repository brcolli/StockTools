...
def main():
    ...
    dam.augment_data(random_text_aug=True, random_total=0.6, total_aug_to_make=5000,
                     to_file='../data/Learning Data/spam_train_aug.csv',
                     from_file='../data/Learning Data/spam_train.csv')
